...
This sample showcases the **`verify`** Copilot CLI skill — an end-to-end app verification pipeline that runs on [Playwright Workspaces (PWW)](https://aka.ms/pww/docs) cloud browsers.
